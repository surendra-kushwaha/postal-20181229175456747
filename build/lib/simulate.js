...
var _postal = require('./postal');var _postal2 = _interopRequireDefault(_postal);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // eslint-disable-line no-unused-vars
...
function generatestatus(step, datestatus, typeofpatch, randomreceivedExcess) {
  ...
  switch (step) {
    ...
    case 0:
      ...
      datestatus.setDate(datestatus.getDate() + _config2.default.simulate.days[0]);
      break;
    case 1:
      //     if (typeofpatch !== 'receivedExcess') {
    ...
    case 2:
      ...
      datestatus.setDate(datestatus.getDate() + _config2.default.simulate.days[1]);
      break;
    case 3:
      if (typeofpatch !== 'receivedExcess') {
    ...
    case 4:
      ...
      datestatus.setDate(datestatus.getDate() + _config2.default.simulate.days[2]);
      break;
    case 5:
      if (typeofpatch !== 'receivedExcess') {
    ...
    case 6:
      ...
      datestatus.setDate(datestatus.getDate() + _config2.default.simulate.days[3]);
      break;
    case 7:
    ...
    case 9:
      ...
      datestatus.setDate(datestatus.getDate() + _config2.default.simulate.days[4]);
      break;
    case 10:
      actualStatus = ['EDB']; // Into Customs
      datestatus.setDate(datestatus.getDate() + _config2.default.simulate.days[5]);
      break;
    case 11:
    ...
    case 12:
      ...
      datestatus.setDate(datestatus.getDate() + _config2.default.simulate.days[6]);
      break;
    case 13:
    ...
    case 14:
      ...
      datestatus.setDate(datestatus.getDate() + _config2.default.simulate.days[7]);
      break;}
...
class DispatchSimulator {constructor() {this.
    simulate = (
    size,
    origin,
    destination,
    ...
    endDate) =>
    {
      let repeatpackage = 1;
      if (size === 'small') {
        repeatpackage = _config2.default.simulate.size.small;
      } else if (size === 'medium') {
        repeatpackage = _config2.default.simulate.size.medium;
      } else if (size === 'large') {
        repeatpackage = _config2.default.simulate.size.large;
      }
      ...
      repeatpackage * _config2.default.simulate.ReceivedinExcess_rate / 100);

      _logger2.default.info(
      ` Packets with rate NumOfRecInExcess      ${rateNumOfRecInExcess}`);

      const rateNumOfLostParcel = Math.round(
      repeatpackage * _config2.default.simulate.LostParcel_rate / 100);

      _logger2.default.info(
      ` Packets with rate NumOfLostParcel       ${rateNumOfLostParcel}`);

      const rateNumOfSeizedorReturned = Math.round(
      repeatpackage * _config2.default.simulate.SeizedorReturned_rate / 100);
      ...
      for (let j = 0; j < repeatpackage; j += 1) {
        ...
        const daysofstatus = _config2.default.simulate.days;
    ...
    createpackage = EDImessage => {
      for (let i = 0; i < EDImessage.length; i += 1) {
        _postal2.default.createPackage(EDImessage[i]);
      }
      return EDImessage;
    };this.


    updatepackage = EDImessage => {
      ...
      _postal2.default.updateShipmentStatus(payload);
      return EDImessage;
